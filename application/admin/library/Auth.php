...
//        }
    ...
    public function getSidebar($params = [], $fixedPage = 'dashboard')
    {
        ...
        foreach ($ruleList as $k => &$v) {
            ...
            $v['menuclass'] = (isset($v['menutype']) && in_array($v['menutype'], ['dialog', 'ajax'])) ? 'btn-' . $v['menutype'] : '';
            $v['menutabs'] = isset($v['menutype']) && in_array($v['menutype'], ['default', 'addtabs']) ? 'addtabs="' . $v['id'] . '"' : '';
