<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:90:"/Users/hujun/hujun/yjt/1.5.0.20240328/public/../application/index/view/user/changepwd.html";i:1711598594;s:80:"/Users/hujun/hujun/yjt/1.5.0.20240328/application/index/view/layout/default.html";i:1711598594;s:77:"/Users/hujun/hujun/yjt/1.5.0.20240328/application/index/view/common/meta.html";i:1711598594;s:80:"/Users/hujun/hujun/yjt/1.5.0.20240328/application/index/view/common/sidenav.html";i:1711598594;s:79:"/Users/hujun/hujun/yjt/1.5.0.20240328/application/index/view/common/script.html";i:1711598594;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                    ...
                    <form id="changepwd-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <input type="password" class="form-control" id="oldpassword" name="oldpassword" value="" data-rule="required;password" placeholder="<?php echo __('Old password'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="newpassword" class="control-label col-xs-12 col-sm-2"><?php echo __('New password'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
                                <input type="password" class="form-control" id="newpassword" name="newpassword" value="" data-rule="required;password" placeholder="<?php echo __('New password'); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="renewpassword" class="control-label col-xs-12 col-sm-2"><?php echo __('Renew password'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
                                <input type="password" class="form-control" id="renewpassword" name="renewpassword" value="" data-rule="required;password" placeholder="<?php echo __('Renew password'); ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group normal-footer">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <button type="submit" class="btn btn-primary btn-embossed disabled"><?php echo __('Submit'); ?></button>
